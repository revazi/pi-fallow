...
- **Fallow quality:** Fallow 3.21 reports health **83.1 (B)**, average maintainability **91.5**, and zero threshold findings, dead-code issues, or clone groups.
...
- package-boundary certification against Pi 0.84.4 and Fallow 3.21 on the tested Node lines;
