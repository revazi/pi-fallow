...
- **Fallow quality:** Fallow 3.18 reports health **85.0 (A)**, average maintainability **91.9**, and zero threshold findings, dead-code issues, or clone groups.
...
- package-boundary certification against Pi 0.84.3 and Fallow 3.18 on the tested Node lines;
