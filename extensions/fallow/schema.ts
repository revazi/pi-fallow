...
export const fallowRunParams = Type.Object({
	...
	changedSince: Type.Optional(Type.String({ description: "Git ref for changed-file analysis (for dead-code, dupes, health, or check-changed)." })),
	base: Type.Optional(Type.String({ description: "Audit base ref. Alias of changedSince for audit." })),
