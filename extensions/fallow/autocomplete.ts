...
const COMMON_FLAGS: FlagSpec[] = [
	...
	{ flag: "--baseline-mode", description: "Match health baselines by count or strict finding identity", values: ["count", "identity"] },
	{ flag: "--type-aware", description: "Opt in to bounded TypeScript semantic analysis" },
	{ flag: "--no-type-aware", description: "Force this run to remain syntactic" },
...
const FLAGS_BY_COMMAND: Record<string, FlagSpec[]> = {
	...
	"dead-code": [
		...
		{ flag: "--symbol-impact", description: "Find exact consumers, affected files, and targeted tests for file:export-or-class.method" },
	],
	...
	health: [
		...
		{ flag: "--type-coupling", description: "Include advisory public-signature type coupling (requires type-aware analysis)" },
		{ flag: "--score", description: "Compute project health score/grade" },
