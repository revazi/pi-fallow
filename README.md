...
For compatibility, the existing `o` Status / Setup / Run workflow remains available from all three views. It still leaves the overlay for separate dialogs until the later integration work lands.
